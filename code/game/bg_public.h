...
// CS_SERVERINFO, CS_SYSTEMINFO and CS_PLAYERS are defined in q_shared.h
...
enum {
    ...
    DEMOCS_GAME_VERSION = 16,
    DEMOCS_LEVEL_START_TIME,
    DEMOCS_INTERMISSION,
    DEMOCS_SHADERSTATE,
    DEMOCS_BOTINFO,

    DEMOCS_GAMETYPE_TIMER,
    DEMOCS_GAMETYPE_MESSAGE,
    DEMOCS_GAMETYPE_REDTEAM,
    DEMOCS_GAMETYPE_BLUETEAM,

    DEMOCS_ITEMS = 28,


    DEMOCS_MODELS = 32,
    DEMOCS_SOUNDS = DEMOCS_MODELS + MAX_MODELS,
    DEMOCS_PLAYERS = DEMOCS_SOUNDS + MAX_SOUNDS,
    DEMOCS_LOCATIONS = DEMOCS_PLAYERS + (MAX_CLIENTS * 2),
    DEMOCS_LADDERS = DEMOCS_LOCATIONS + MAX_LOCATIONS,
    DEMOCS_BSP_MODELS = DEMOCS_LADDERS + MAX_LADDERS,
    DEMOCS_TERRAINS = DEMOCS_BSP_MODELS + MAX_SUB_BSP,
    DEMOCS_EFFECTS = DEMOCS_TERRAINS + MAX_DEMO_TERRAINS,
    DEMOCS_LIGHT_STYLES = DEMOCS_EFFECTS + MAX_FX,
    DEMOCS_ICONS = DEMOCS_LIGHT_STYLES + (MAX_LIGHT_STYLES * 3),
    DEMOCS_TEAM_INFO = DEMOCS_ICONS + MAX_ICONS,
    DEMOCS_AMBIENT_SOUNDSETS = DEMOCS_TEAM_INFO + TEAM_NUM_TEAMS,

    DEMOCS_MAX = DEMOCS_AMBIENT_SOUNDSETS + MAX_AMBIENT_SOUNDSETS
...
//
// Game module memory management system.
//
