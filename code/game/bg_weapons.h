...
typedef enum
{
    ...
    // Pistols
    L_MOD_M1911A1_PISTOL,
    L_MOD_USSOCOM_PISTOL,

    // Secondarys
    L_MOD_M590_SHOTGUN,
    L_MOD_MICRO_UZI_SUBMACHINEGUN,
    L_MOD_M3A1_SUBMACHINEGUN,

    // Primaries
    L_MOD_USAS_12_SHOTGUN,
    L_MOD_M4_ASSAULT_RIFLE,
    L_MOD_AK74_ASSAULT_RIFLE,
    L_MOD_MSG90A1_SNIPER_RIFLE,
    L_MOD_M60_MACHINEGUN,
    L_MOD_MM1_GRENADE_LAUNCHER,
    L_MOD_RPG7_LAUNCHER,
    ...
    //END
} legacyMeansOfDeath_t;

typedef struct meansOfDeathDiff_s {
    meansOfDeath_t mod;
    legacyMeansOfDeath_t translatedMod;
} meansOfDeathDiff_t;
...
typedef struct weaponDiff_s {
    weapon_t weapon;
    legacyWeapon_t translatedWeapon;
} weaponDiff_t;
...
typedef struct ammoDiff_s {
    ammo_t ammo;
    legacyAmmo_t translatedAmmo;
} ammoDiff_t;
