...
typedef enum
{
    ...
    L_MODELINDEX_ARMOR_BIG,           // 1
    L_MODELINDEX_ARMOR_MEDIUM,
    L_MODELINDEX_ARMOR_SMALL,
    L_MODELINDEX_HEALTH_BIG,
    L_MODELINDEX_HEALTH_SMALL,

    L_MODELINDEX_WEAPON_KNIFE,        // 6
    L_MODELINDEX_WEAPON_SOCOM,
    L_MODELINDEX_WEAPON_M19,
    L_MODELINDEX_WEAPON_MICROUZI,
    L_MODELINDEX_WEAPON_M3A1,

    L_MODELINDEX_WEAPON_USAS12,       // 11
    L_MODELINDEX_WEAPON_M590,
    L_MODELINDEX_WEAPON_MSG90A1,
    L_MODELINDEX_WEAPON_M4,
    L_MODELINDEX_WEAPON_AK74,

    L_MODELINDEX_WEAPON_M60,          // 16
    L_MODELINDEX_WEAPON_RPG7,
    L_MODELINDEX_WEAPON_MM1,
    L_MODELINDEX_WEAPON_M67,
    L_MODELINDEX_WEAPON_M84,

    L_MODELINDEX_WEAPON_F1,           // 21
    L_MODELINDEX_WEAPON_L2A2,
    L_MODELINDEX_WEAPON_MDN11,
    L_MODELINDEX_WEAPON_SMOHG92,
    L_MODELINDEX_WEAPON_ANM14,

    L_MODELINDEX_WEAPON_M15,          // 26
    L_MODELINDEX_AMMO_045,
    L_MODELINDEX_AMMO_9MM,
    L_MODELINDEX_AMMO_12GAUGE,
    L_MODELINDEX_AMMO_762,

    L_MODELINDEX_AMMO_556,            // 31
    L_MODELINDEX_AMMO_40MM,
    L_MODELINDEX_AMMO_RPG7,
    L_MODELINDEX_BACKPACK,

    L_MODELINDEX_GAMETYPE_ITEM,
    L_MODELINDEX_GAMETYPE_ITEM_2,
    L_MODELINDEX_GAMETYPE_ITEM_3,
    L_MODELINDEX_GAMETYPE_ITEM_4,
    L_MODELINDEX_GAMETYPE_ITEM_5,

    L_MODELINDEX_ARMOR,
    L_MODELINDEX_NIGHTVISION,
    L_MODELINDEX_THERMAL,

} legacyModelIndex_t;

typedef struct modelIndexDiff_s {

    modelIndex_t modelIndex;
    legacyModelIndex_t translatedIndex;
